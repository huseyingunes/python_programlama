'''
kendisine gelen parametreye göre iki farklı
    json döndüren flask apiyi yazınız.

localhost:5678/getir/1
localhost:5678/getir/2
...
@app.route("/getir/<int:getir_id>")
def getir(getir_id):
    a = '{"id":1,"title":"iPhone 9","description":"An apple mobile which is nothing like apple","price":549,"discountPercentage":12.96,"rating":4.69,"stock":94,"brand":"Apple","category":"smartphones","thumbnail":"https://i.dummyjson.com/data/products/1/thumbnail.jpg","images":["https://i.dummyjson.com/data/products/1/1.jpg","https://i.dummyjson.com/data/products/1/2.jpg","https://i.dummyjson.com/data/products/1/3.jpg","https://i.dummyjson.com/data/products/1/4.jpg","https://i.dummyjson.com/data/products/1/thumbnail.jpg"]}'
    ...
    if getir_id == 1:
        ...
        araba = {'marka': 'Ford', 'model': 'Mustang', 'yil': 1976}
        return jsonify(araba)
